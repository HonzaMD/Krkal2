...
!define KERNEL_VERSION "x"
!define OLDCRC 1685343251
!define FULL_FILES "..\..\bin"
;!system "createtempbin.cmd ${FULL_FILES}"
!define FULL_FILES2 "${FULL_FILES}2"
!define OUTPUT_DIR "..\..\"
...
OutFile "${OUTPUT_DIR}Krkal${PRODUCT_VERSION}.exe"
