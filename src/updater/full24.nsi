...
!define FULL_FILES "..\..\Krkal old\krkal2.4"
...
Function un.onInit
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Opravdu si pøejete úplnì odstranit Krkala a všechny jeho komponenty?" IDYES ano1
  Abort
  ano1:
