...
#define BEAUTY_RENDER_ELEMENT_CLASS_ID			0x10000001
#define SPECULAR_RENDER_ELEMENT_CLASS_ID		0x10000002
#define SPECULAR_SELECT_RENDER_ELEMENT_CLASS_ID	0x10000003
#define DIFFUSE_RENDER_ELEMENT_CLASS_ID			0x10000004
#define EMISSION_RENDER_ELEMENT_CLASS_ID		0x10000005
#define REFLECTION_RENDER_ELEMENT_CLASS_ID		0x10000006
#define REFRACTION_RENDER_ELEMENT_CLASS_ID		0x10000007
#define SHADOWS_RENDER_ELEMENT_CLASS_ID			0x10000008
#define ATMOSPHERE_RENDER_ELEMENT_CLASS_ID		0x10000009
#define ATMOSPHERE2_RENDER_ELEMENT_CLASS_ID		0x1000000a
#define BLEND_RENDER_ELEMENT_CLASS_ID			0x1000000b
#define Z_RENDER_ELEMENT_CLASS_ID				0x1000000c
#define ALPHA_RENDER_ELEMENT_CLASS_ID			0x1000000d
#define CLR_SHADOW_RENDER_ELEMENT_CLASS_ID		0x1000000e
#define BGND_RENDER_ELEMENT_CLASS_ID			0x1000000f
#define SPECULAR_COMP_RENDER_ELEMENT_CLASS_ID	0x10000010
#define NORMAL_RENDER_ELEMENT_CLASS_ID			0x10000011
#define AMBIENT_RENDER_ELEMENT_CLASS_ID			0x10000012
...
extern ClassDesc* GetNormalElementDesc();
extern ClassDesc* GetAmbientElementDesc();
